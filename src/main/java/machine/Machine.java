...
import static machine.TypesOfCoffee.*;

public class Machine {
    private MachineActions state;
    private int water;
    private int milk;
    private int coffee;
    private int cups;
    ...
    public boolean isWorking() {
        return state != MachineActions.OFF;
    }
    ...
    public void execute(String input) {
        switch (state) {
            ...
            case FILLING_WATER:
                ...
                state = MachineActions.FILLING_MILK;
                break;
            case FILLING_MILK:
                milk += Integer.parseInt(input);
                System.out.print("Write how many grams of coffee beans do you want to add:\n> ");
                state = MachineActions.FILLING_COFFEE;
                break;
            case FILLING_COFFEE:
                coffee += Integer.parseInt(input);
                System.out.print("Write how many disposable cups of coffee do you want to add:\n> ");
                state = MachineActions.FILLING_CUPS;
                break;
            case FILLING_CUPS:
    ...
    public void setState(String command) {
        switch (command) {
            ...
            case "buy":
                ...
                state = MachineActions.BUYING;
                break;
            case "fill":
                System.out.print("Write how many ml of water do you want to add:\n> ");
                state = MachineActions.FILLING_WATER;
                break;
            case "take":
                giveMoney();
                setMainState();
    ...
    private void makeCoffee(TypesOfCoffee recipe) {
